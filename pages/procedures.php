...
<head>
    ...
    <title>Procedures - <?php echo $data_web['title'] ?></title>
    ...
    <header class="BgScrollEffect about-us">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item active dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-2">
                                    ...
                                    <a class="dropdown-item active" href="./procedures.php">
                                        <span class="iconify" data-icon="dashicons:arrow-right-alt2"></span>
                                        Procedures
                                    </a>
                                </div>
        ...
        <div class="container WrapContent">
            <div class="ContentOnBackGround ElementScrollEffect right">
                <h5 class="heading--sub">How do we do it?</h5>
                <span class="dash"></span>
                <h2 class="heading">DENTAL PROCEDURES</h2>
                <p class="text">Mauris non sagittis sem. Fusce iaculis rhoncus urna vel tincidunt. Donec ac nisl ac diam vestibulum.</p>
            </div>
        </div>
    </header>
