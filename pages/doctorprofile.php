...
<head>
    ...
    <title>Doctors profile - <?php echo $data_web['title'] ?></title>
    ...
    <header class="BgScrollEffect about-us">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item active dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item active" href="./doctorprofile.php">
                                        <span class="iconify" data-icon="dashicons:arrow-right-alt2"></span>
                                        Doctors profile
                                    </a>
        ...
        <div class="container WrapContent">
            <div class="ContentOnBackGround ElementScrollEffect right">
                <h5 class="heading--sub">Dental Surgeon</h5>
                <span class="dash"></span>
                <h2 class="heading">DR JENNA WILSON</h2>
                <p class="text">Dr. Jenna Wilson is is dedicated to providing her patients with the most beautiful smile together with the best dental protection available nowadays.</p>
            </div>
        </div>
    </header>
