            ...
            <div class="panel-body">
                <form action="' . $_DOMAIN . 'profile.php" method="POST" onsubmit="return false;" id="formUpAvt" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="img_avt" accept="image/*" name="img_avt" onchange="preUpAvt();" style="display: none">
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary pull-left" type="submit"><span class="glyphicon glyphicon-cloud-upload"></span> Upload</button>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="POST" id="formChangePw" onsubmit="return false;">
                    <div class="form-group">
                        <label for="old_pw_change">Mật khẩu cũ</label>
                        <input type="password" class="form-control" id="old_pw_change">
                    </div>
                    <div class="form-group">
                        <label for="new_pw_change">Mật khẩu mới</label>
                        <input type="password" class="form-control" id="new_pw_change">
                    </div>
                    <div class="form-group">
                        <label for="re_new_pw_change">Nhập lại mật khẩu mới</label>
