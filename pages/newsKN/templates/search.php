<div class="container">
    <h3 style="margin-top: 30px;">Kết quả tìm kiếm</h3>
    <div class="row" style="margin-bottom: 30px">
        ...
        if ($s) {
            ...
            if ($db->num_rows($sql_get_news)) {
                foreach ($db->fetch_assoc($sql_get_news, 1) as $data_post) {
                    echo '
                        <div class="col-md-3">
                            <div class="thumbnail">
                ...
                echo '<div class="alert alert-info" style="width: 100%;">Không tìm thấy kết quả nào.</div>';
            }
        } else {
            echo'
                <div class="alert alert-danger" style="width: 100%;">
                    Vui lòng nhập kết quả tìm kiếm.
                </div>
                ';
        }
