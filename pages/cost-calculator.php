...
<head>
    ...
    <title>Cost calculator - <?php echo $data_web['title'] ?></title>
...
<body>
    ...
    <header class="BgScrollEffect about-us">
        ...
        <div class="container WrapContent">
            <div class="ContentOnBackGround ElementScrollEffect right">
                <h5 class="heading--sub">Dental cost estimate</h5>
                <span class="dash"></span>
                <h2 class="heading">FREE ONLINE QUOTE</h2>
                ...
                <div class="content--btn content--btn--left mr-3 d-inline-block" href="#" data-toggle="modal"
                    data-target="#myAppointment">
                    <span>BOOK NOW</span>
                </div>
    ...
    <footer>
        ...
        <div class="copyright">
            <div class="content">
                Copyright &#169;
                <script>document.write(new Date().getFullYear())</script> DentalCare <br>Made by <a
                    href="https://www.facebook.com/khoa.nguyenvan.99" target="_blank">Khoa Nguyen</a>
            </div>
        </div>
    </footer>
                ...
                <div class="modal-body">
                    <form action="<?php echo $_DOMAIN_Client . 'verifyEmail.php' ?>" method="POST" class="form" id="form-1">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="fullname" class="form-label">Tên đầy đủ<span class="mandatory">
                                            *</span></label>
                                    <input id="fullname" name="fullname" type="text" placeholder="VD: Khoa Nguyễn"
                                        class="form-control">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="phone-number" name="phone-number" type="text" placeholder="Số điện thoại"
                                        class="form-control">
                                    <span class="form-message"></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="formDate" class="form-label">Lịch hẹn<span class="mandatory">
                                            *</span></label>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="formTimes" class="form-label">Chọn thời gian phù hợp với bạn<span
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="formAddress" class="form-label">Địa chỉ<span class="mandatory">
                                            *</span></label>
                                    <input id="formAddress" name="address" type="text" placeholder="Địa chỉ của bạn"
                                        class="form-control">
                                    <span class="form-message"></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="services" class="form-label">Dịch vụ của bạn là gì<span class="mandatory">
                                    *</span></label>
                            ...
                            <div class="row" id="formServices">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="checkbox" id="service-8" name="service"
                                        value="Mặt dán răng sứ Veneers">
                        ...
                        <div class="form-group">
                            <label for="form-field-message" class="form-label">Nếu bạn cần hỏi điều gì hoặc muốn gửi các
                                thông tin về mối quan tâm
                                của bạn vui lòng điền vào khung bên dưới.</label>
                            <textarea name="form-field-message" id="form-field-message" cols="100%" rows="5"
